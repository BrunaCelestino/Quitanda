...
public class ManagerRepository {
    ...
    public static Manager createManager() {
        ...
        String password = input.next();
            ...
            Manager manager = new Manager(name, CPF, address, email, phone, registerType, registrationNumber, bankInformation,scheduleTime, username, password);


            BufferUtil<Manager> buffer = new BufferUtil<Manager>();
            buffer.writeFile(manager, "manager");
            System.out.println();
